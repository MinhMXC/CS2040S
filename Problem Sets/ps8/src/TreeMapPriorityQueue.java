...
public class TreeMapPriorityQueue<Priority extends Comparable<Priority>, Key extends Comparable<Key>> {
	...
	// Modified to know whether the key is decreased or not
	boolean decreasePriority(Key k, Priority p){
		Node n = m_map.get(k);
	...
	public static void main(String[] arg){
		TreeMapPriorityQueue<Integer, String> pq = new TreeMapPriorityQueue<>();
